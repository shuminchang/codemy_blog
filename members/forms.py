...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = ('bio', 'profile_pic', 'website_url', 'github_url', 'facebook_url', 'twitter_url', 'instagram_url', 'pinterest_url')
...
class EditProfileForm(UserChangeForm):
    ...
    is_superuser = forms.CharField(max_length=100, disabled=True, widget=forms.CheckboxInput(attrs={'class': 'form-check'}))
    is_staff = forms.CharField(max_length=100, disabled=True, widget=forms.CheckboxInput(attrs={'class': 'form-check'}))
    is_active = forms.CharField(max_length=100, disabled=True, widget=forms.CheckboxInput(attrs={'class': 'form-checkt'}))
